...
\paragraph*{DIASources}
Orphan' DIASources from the last night of observing.  This means DIASources that are not associated with a DIAObject.  DIASources associated with an SSObject in the night are still passed through the MOPS machinery

DIAObject database

SSObject database

Exposure metadata database
