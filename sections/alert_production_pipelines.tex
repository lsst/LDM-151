...
\item Apply a \hyperref[sec:artifact]{cosmic ray detection algorithm}
\item Generate a summed and difference image from the individual snaps
\end{itemize}
...
\subsubsection{Alert Distribution: To community brokers}
