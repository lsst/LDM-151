...
Delegate to the \hyperref[sec:acSingleVisitPhotometricFit]{Single Visit Photometric Fit algorithmic component} to fit the zeropoint of the exposure (possibly including some spatial variation to account for grey clouds).
