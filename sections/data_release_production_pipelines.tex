...
The final output data products of the ImChar/JointCal iteration are the Source table and CalExp (calibrated exposure) images.  The latter includes Image, Mask, Variance, Background, PSF, WCS, and PhotoCalib components that we will track separately.
...
\item[TemplateCoadd] A coadd data product used for difference imaging in both DRP and AP, or a suite of coadd data products from which the template for a given airmass can be derived.
\end{description}
