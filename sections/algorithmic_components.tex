...
\subsection{Reference Catalog Construction: Princeton}
...
\subsection{Instrument Signature Removal: UW}
\label{sec:acISR}
AUTHOR: Merlin
\begin{itemize}
...
\subsubsection{Single-Exposure Morphology: UW}
...
\subsubsection{Single-Exposure Aggregation: UW}
...
\subsubsection{Snap Subtraction: UW}
...
\subsubsection{Warped Image Comparison: Princeton?}
...
\subsection{Artifact Interpolation: Princeton?}
...
\subsection{Source Detection: Princeton}
...
\subsubsection{Single Frame Deblending: Princeton}
...
\subsubsection{Multi-Coadd Deblending: Princeton}
...
\subsection{Measurement: Princeton}
...
\subsubsection{Drivers: Princeton}
...
\subsubsection{Algorithms: Princeton}
...
\subsubsection{Blended Measurement: UW}
...
\subsection{Background Estimation: UW?}
...
\subsubsection{Tract Level: Princeton}
...
\subsection{PSF Estimation -- Not sure how to divide this up.}
\label{sec:acPSFEstimation}

\subsubsection{Single CCD PSF Estimation: UW}
...
\subsection{Wavefront Sensor PSF Estimation: UW}
...
\subsubsection{Full Visit PSF Estimation: Princeton}
...
\subsection{Aperture Correction: Princeton}
\label{sec:acApCorr}
AUTHOR: Jim
\begin{itemize}
...
\subsubsection{Joint Multi-Visit: UW}
...
\subsubsection{Single CCD (for AP): UW}
...
\subsection{Retrieve Diffim Template for a Visit: UW}
...
\subsubsection{Image Subtraction: UW}
...
\subsubsection{PSF Homogenization for Coaddition: Princeton}
...
\label{sec:acWarping}
AUTHOR: Jim
\subsubsection{Oversampled Images: UW}
...
\subsubsection{Undersampled Images: UW?}
...
\subsection{DCR-Corrected Template Generation: UW}
...
\subsubsection{Difference Image Decorrelation: UW}
...
\subsubsection{Coadd Decorrelation: Princeton}
...
\subsection{Star/Galaxy Classification: Princeton?}
...
\subsection{Variability Characterization: UW}
...
\subsection{Proper Motion and Parallax from DIASources: UW}
...
\subsubsection{Single CCD to Reference Catalog, Semi-Blind: UW}
...
\subsubsection{Single Visit to Reference Catalog, Semi-Blind: UW}
...
\subsubsection{Multiple Visits to Reference Catalog: Princeton}
...
\subsubsection{DIAObject Generation: UW}
...
\subsubsection{Object Generation: Princeton}
...
\subsubsection{Blended Overlap Resolution: Princeton}
...
\subsection{Raw Measurement Calibration: Princeton}
...
\subsection{Ephemeris Calculation: UW}
...
\subsection{Attribution and precovery: UW}
