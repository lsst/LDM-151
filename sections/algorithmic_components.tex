...
\item Pixel level corrections:
	\subitem The \bfeffect: Apply brighter fatter correction. \XXX{To do: need to add proper section about this somewhere as this is a non-trivial ISR algorithm.}
	\subitem Static pixel size effects: tree rings, spider legs \etc. \XXX{To do: need to add proper section on these somewhere (here?) as this is another non-trivial ISR algorithm.}
...
\item Generate snap difference: \rednote{is this really part of ISR?}

\item Snap combination: \rednote{is this really part of ISR?}
