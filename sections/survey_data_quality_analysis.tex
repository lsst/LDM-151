...
Science Data Quality Assurance (SDQA) describes a collection of capabilities for Quality Analysis (QA) and Quality Control (QC) that collectively ensure a high quality performing software system as well as the ability to meet the scientific goals of the system.

\subsubsection{Quality Analysis (QA)}

Quality Analysis describes a range of {\em activities} aimed at understanding the algorithmic performance of the code and eventually the properties of the data. These are achieved by a set of {\em tools} that leverage components of the Data Management subsystem, as well as additional capabilities as necessary, to allow for the scientific inspection of data both by DM developers and scientists during construction as well as commissioning engineers and scientists during commissioning and operations.

\subsubsection{Quality Control (QC)}

Quality Control describes a range of {\em services} aimed at measuring and monitoring and characterising the system (both software and data) to verify and characterise its performance. Whereas Quality Assurance describes the activities of people, Quality Control describes systems running autonomously and only notify people when an anomaly that cannot be automatically rectified is detected. 

A view of QC services is shown in \figure{fig:qa-overview}. Capabilities are increasingly progressive (eg. tier QA-1 includes QA-0 services). A definition of the QA tiers is given in the rest of this section. 
...
\em{[@KT - who deals wih the bad data system?]}
