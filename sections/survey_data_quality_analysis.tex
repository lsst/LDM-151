...
These are implemented in a manner that is agnostic as to the implementation of the Workflow (eg. they are values in a database table or API methods that different workflow systems can utilize). 
