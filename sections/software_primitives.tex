...
\subsubsection{Arrays of Points: UW}
...
\subsubsection{Ellipses: Princeton}
...
\subsubsection{Simple Images: Princeton}
...
\subsubsection{MaskedImages: Princeton}
...
\subsubsection{Exposure: Princeton?}
...
\subsection{Multi-Type Associative Containers: UW?}
...
\subsection{Footprints: Princeton}
...
\subsection{Basic Statistics: Princeton}
...
\subsection{Chromaticity Utilities: UW?}
...
\subsection{PhotoCalib: Princeton?}
...
\subsection{Convolution Kernels: Princeton}
\label{sec:spKernels}
...
\subsection{Coordinate Transformations: UW}
\label{sec:spWCS}
...
\subsection{Numerical Integration: Princeton}
...
\subsection{Random Number Generation: Princeton}
...
\subsection{Interpolation and Approximation of 2-D Fields: UW?}
...
\subsection{Common Functions and Source Profiles: UW}
...
\subsection{Camera Descriptions: UW}
...
\subsection{Numerical Optimization: Princeton}
...
\subsection{Monte Carlo Sampling: Princeton}
...
\subsection{Point-Spread Functions: UW}
\label{sec:spPSF}
