...
% \item{Static non-uniform pixel sizes (e.g.\ ``tree rings'' \cite{2014JInst...9C3032S});}
% \item{Dynamic electric fields (e.g.\ ``brighter-fatter'' \cite{1748-0221-9-03-C03048});}
...
%
%The adopted baseline algorithm is a variant of ``ubercal'' \cite{2008ApJ...674.1217P, 2012ApJ...756..158S}. This baseline is described in detail in the Photometric Self Calibration Design and Prototype Document (\UCAL).
%
