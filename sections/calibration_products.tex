...
\begin{itemize}
  ...
  \item{It will characterize of detector anomalies in such a way that they can be corrected either by the ISR routines in the Single Frame Processing Pipeline (\wbsSFM) or, if appropriate, elsewhere in the system;}
