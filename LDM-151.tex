...
\setDocDOI{10.71929/rubin/2587108}

% Keep the date of the release before we added the DOI. Changing the date
% by five years to add one line to the first page was deemed to be too
% confusing and would imply more changes than really happened.
% Change back to \today if a real edit of content is done.
\date{2020-11-10}
...
\addtohist{4.3.1}{2025-09-01}{Add DOI of 10.71929/rubin/2587108 but to avoid confusion do not update the formal date in the front matter.}{Tim Jenness}
}
