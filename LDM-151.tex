...
\author{
    M.~Juri\'c,
    R.H.~Lupton, T.~Axelrod, A.C.~Becker, J.~Becla, E.~Bellm,
    ...
    J.~Swinbank,  M.~Wood-Vasey, X.~Wu, P.~Yoachim,
...
\addtohist{4}{2017-04-XX}{Major reorganization for DM replan}{Many authors}
}
