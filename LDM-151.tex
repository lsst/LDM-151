% this now uses lsstdoc.cls from https://github.com/mjuric/lsst_texdoc
\documentclass[DM,lsstdraft,SDD]{lsstdoc}



\setDocRef      {LDM-151} % the reference code
\setDocIssue    {3}                        % the issue
\setDocRevision {1}                        % the revision
\setDocDate     {\today}              % the date of the issue
\setDocStatus   {draft}                    % the document status


\setDocTitle [Application Design] {Large Synoptic Survey Telescope \\
...
% MOST RECENT FIRST
\begin{docHistory}
\addtohist{3}{1}{2015-0-0}{KTL, JB, FE, SK, JS, et al.}{Work in progress as part of 2015 replanning
exercise}
\addtohist{3}{0}{2013-10-07}{MJ}{Updates for consistency with FDR baseline}
\addtohist{2}{0}{2011-08-04}{TA}{Elevated to LDM handle; general updates and
edits}
\addtohist{1}{0}{2009-03-26}{TA, et. al }{Initial version as Document-7396 } 
\end{docHistory}
