...
\paragraph{PSF determination:} \note{Both DRM and AP will need PSF determination.  Likely they will use the
...
\paragraph{WCS determination and image registration} \note{This is actually a different WBS(02C.03.08), though
...
\paragraph{Template generation}\note{This is in 02C.04, but will be informed by \dlplink{DLP-278}, \dlplink{DLP-277}, and \dlplink{DLP-281}}
...
\paragraph{Construct Difference} \note{\dlplink{DLP-274}}
...
\subsubsection{Baseline design} \note{\dlplink{DLP-268}; This also requires NightMOPS (02C.03.06)
\dlplink{DLP-293}}
...
\note{I don't think this is true anymore} The prototype code is available at \url{https://github.com/lsst/ap}. The current prototype, while functional, will require a partial redesign in Construction to address scalability and performance.
...
\paragraph{Event packet construction} \note{\dlplink{DLP-271}}

\paragraph{Event packet distribution} \note{\dlplink{DLP-273}}

\paragraph{Simple filtering engine} \note{\dlplink{DLP-272}}
...
\paragraph{Tracklet generation and collapse} \note{\dlplink{DLP-294} and \dlplink{DLP-296}}

\paragraph{Link tracklets} \note{\dlplink{DLP-306}}

\paragraph{Orbit fitting} \note{\dlplink{DLP-297}}
