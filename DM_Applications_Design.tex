...
\bibitem{BailerJones10} C. A. L.~Bailer-Jones,
	\textbf{The ILIUM forward modelling algorithm for multivariate parameter estimation and its application to derive stellar parameters from Gaia spectrophotometry}
	Monthly Notices of the Royal Astronomical Society 403.1, 96-116 (2010).
...
\bibitem{Bosch15} J.~Bosch,
  ...
  LSST Data Management Technical Note, DMTN-038, 2015.
...
\bibitem{GaiaSpecs} The Gaia Team,
\textbf{Science Performance of the Gaia Mission}
 \url{https://www.cosmos.esa.int/web/gaia/science-performance}

\bibitem{Holberg16} G.~Narayan, et al,
\textbf{Toward a Network of Faint {DA} White Dwarfs as High-precision Spectrophotometric Standards},
 The Astrophysical Journal 822.2: 67 (2016).
...
\bibitem{Yagi12} M.~ Yagi,
\textbf{Crosstalk Analysis of Suprime-Cam {FDCCDs} Using Cosmic Rays in Dark Frames}, Publications of the Astronomical Society of the Pacific 124.922, 1347 (2012).
...
\bibitem{budavariSzalay2008} Budav{\'a}ri, T. and Szalay, A.~S.,
    \textbf{Probabilistic Cross-Identification of Astronomical
      Sources}, ApJ, 679, 301-309 (2008)

\bibitem{canny86} Canny, J., \textbf{A Computational Approach to Edge
    Detection}, IEEE Trans. Pattern Anal. Mach. Intell., 8, 6,
  679--698 (1986)

\bibitem{borncamp_lim16} Borncamp, David \& Lim, P., L., 
...
\bibitem{galamhos99} Galamhos, C., Matas, J., \& Kittler, J.,
...
\bibitem{kubica05} Kubica, Jeremy, Masiero, Joseph, Moore, Andrew,
